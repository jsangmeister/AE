...
\begin{frame}{Überblick}
    \begin{itemize}
        ...
        \item \emph{succincte} Datenstruktur: $2n + o(n)$ Bits Speicherbedarf
...
\begin{frame}{Ergebnisse}
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \includegraphics[width=\textwidth]{graphics/BFO.png}
        \end{column}
        \begin{column}{0.5\textwidth}
            \includegraphics[width=\textwidth]{graphics/DFO.png}
        \end{column}
    \end{columns}
\end{frame}
